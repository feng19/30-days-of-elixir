defmodule SudokuSolver do
  ...
  defp eliminate_vals_from_square(values, square, vals_to_remove, board) do
    ...
    if MapSet.intersection(MapSet.new(vals), MapSet.new(vals_to_remove))
       |> any? do
      ...
      if length(vals) == 0 do
        ...
        values = if length(vals) == 1 do
          ...
          eliminate(values, Map.get(board.peers, square), vals, board)
        else
          values
        end
